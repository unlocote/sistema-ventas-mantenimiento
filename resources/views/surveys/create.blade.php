...
<div class="container">
    ...
    <form id="formEncuesta" action="{{ route('surveys.store') }}" method="POST">
        @csrf
        ...
        <div id="preguntasContainer" class="mt-3">
            <div class="alert alert-secondary text-center" id="noPreguntasMsg">
                No hay preguntas aún. Usa el botón "Añadir pregunta" para comenzar.
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const noPreguntasMsg = document.getElementById('noPreguntasMsg');
    ...
    function abrirModalNuevaPregunta() {
        ...
        agregarOpcion('');
        agregarOpcion('');
        agregarOpcion(''); // 👈 mínimo 3 por defecto
    ...
    function renderPreguntas() {
        ...
        if (preguntas.length === 0) {
            preguntasContainer.appendChild(noPreguntasMsg);
            noPreguntasMsg.style.display = 'block';
            return;
        }

        noPreguntasMsg.style.display = 'none';
